...
async function main() {
    ...
    if (true) {
        ...
        for (let i = 0; i < 50; i++) {
            ...
            const hoursAgo = Math.floor(Math.random() * 12) + 10;
        ...
        DUMMY_ORDERS.push({ orderNumber: 'ORD-LIVE-1', type: 'DINE_IN', status: 'IN_PROGRESS', tableIdx: 0, items: [{ idx: 0, qty: 2 }], minutesAgo: 20 }, { orderNumber: 'ORD-LIVE-2', type: 'DINE_IN', status: 'PENDING', tableIdx: 1, items: [{ idx: 1, qty: 1 }], minutesAgo: 5 }, { orderNumber: 'ORD-LIVE-3', type: 'TAKEAWAY', status: 'READY', tableIdx: null, items: [{ idx: 2, qty: 3 }], minutesAgo: 30 });
